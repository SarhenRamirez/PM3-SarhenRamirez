...
export default function Navbar() {
  ...
  onMouseEnter={e => {
    e.currentTarget.style.background = scrolled ? "rgba(29,78,216,0.12)" : "rgba(255,255,255,0.25)";
  }}
  onMouseLeave={e => {
    e.currentTarget.style.background = scrolled ? "rgba(29,78,216,0.06)" : "rgba(255,255,255,0.15)";
  }}
>
  <LogIn size={16} />
  Iniciar sesión
