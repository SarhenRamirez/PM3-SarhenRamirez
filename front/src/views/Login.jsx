      ...
      <div style={{
        ...
        <div style={{ position: "relative" }}>
          ...
          <p style={{ color: "#bfdbfe", fontSize: "1rem", lineHeight: 1.7, marginBottom: "3rem" }}>
            Accede a tu panel y gestiona tus citas médicas de forma rápida y segura.
          </p>
          <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            {[
              { icon: <Stethoscope size={18} />, texto: "Turnos médicos online" },
              { icon: <CalendarDays size={18} />, texto: "Agenda disponible 24/7" },
              { icon: <CheckCircle size={18} />, texto: "Confirmación inmediata" },
            ].map((item) => (
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem", background: "#f8fafc" }}>
        <div style={{ width: "100%", maxWidth: "420px" }}>
          <div style={{ marginBottom: "2rem" }}>
            <h1 style={{ fontSize: "1.75rem", fontWeight: 800, color: "#0f172a", marginBottom: "8px" }}>Iniciar sesión</h1>
            <p style={{ color: "#64748b", fontSize: "0.95rem" }}>Ingresá tu email y contraseña para continuar</p>
          </div>
