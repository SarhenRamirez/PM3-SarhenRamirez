...
export default function NuevoTurno() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.fecha || !form.hora) {
      return Swal.fire({ icon: "warning", title: "Campos incompletos", text: "Seleccioná una fecha y una hora" });
    }
    setLoading(true);
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
          ...
          <div>
            ...
            <DatePicker
              ...
              onChange={(date) => setForm({ ...form, fecha: date.toISOString().split("T")[0], hora: "" })}
              minDate={hoy}
